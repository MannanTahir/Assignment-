...
*/
let NameOfPerson: string = "ali prince"
...
*/
let NameOfAuthor:string = 'albert einstein'
let quote:string = "A persom who never made a mistake,Never tried anything new."
...
let message:string = "You don't lose untill you give up trying to get you succeed."
...
let messageToShow:string =`${favourite_Number}rd is my  favourite number.`
...
let Num:number = 3 //here Num is number type variable holding 3 digit in it
...
*/
const names: string[] = ['Ali','Hamza','Prince','Ghost']
...
*/
let messge:string = 'Would you like to join us, '
for (let i = 0; i < names.length; i++) {
...
*/
const bikes:string[] = ['Yamaha R1','BMW S1000RR','Honda CBR','Triumph Rocket']
let statement1:string = 'I would like to own '
let statement2:string = 'I would like to ride '
let statement3:string = 'I am a big fan of '
let statement4:string = 'And i like to buy '
const statements: string[] = [statement1,statement2,statement3,statement4]
...
*/
const invitedPersons: string[] = ['Ali','Hamza','Prince']
let message1:string = "Hope so you are doing great.Today is a special day and i would like to invite you for a delicious dinner tonight,and i hope u'll join us tonight."
...
*/
let locations:string[] = ['Seoul','Dhaka','Mumbai','Shingai','Abu dabi']
/*1. print array in its original format*/
...
*/
   let pak_places: string[] = ['Minar e Pakistan','Badshahi Mosque','Clock Tower','Faisal Mosque','Zayarat']
...
*/
const IndexProb: string[] = ['Ali','Hamza','Prince','Bob','james','Nathaniel']
let message2:string = "Hope so you are doing great.Today is a special day and i would like to invite you for a delicious dinner tonight,and i hope u'll join us tonight."
for (let i = 0; i <= IndexProb.length; i++) {
    try {
        let message:string = `Hey ${IndexProb[i].toUpperCase()}!,${message2}`
        console.log(message) 
        message = ""
    } catch (error:any) {
...
*/
let alian_color: string = prompt('Enter a color from Red,Green and Yellow')!
...
*/
let age:number = +prompt('Enter a valid age')!
if(age < 2){
...
*/
const fav_fruits: string[] = ['Banana','Apple','Orange']
...
*/
let usernames:string[] = ['Admin','Ali','Hamza','Prince']
...
*/
const current_users: string[] = ['Ali','Hamza','ghost','Prince','Janu']
const new_users:string[] = ['Ghost','Jani','Janu','Jaan','Ali']
...
*/
const pizza:string[] = ['Pepproni','Chicken Fajita','Chicken Milai Boti']
...
*/
const pets:string[] = ['Dog','Cat','Parrot']
...
/*
Question 36
make a function make_shirt that accepts a size and a statement then return size and statement of shirt by calling function
*/
type shirt = {
    size: number,
    text : string
}
function make_shirt(a: shirt): shirt{
...
*/
 function make_shirtLarge():shirt{
   let a:shirt =  {size : 0, text : ''}
...
/*
Question 38
Make a function city that accepts two parameters name and country And by default country should be PAkistan then return simply a statement city name and country name
*/
type location = {
    city: string,
    country: string
}
function describe_city(city : string,country: string = 'Pakistan'): location{
...
/*
Question 39
Same function but it should take two parameters not a default value and print as 'city name','country name'
*/
type locate = {
    city: string,
    country: string
}
function describe_city1(city : string,country: string): locate{
...
/*
Question 40
Make a function album that accepts artist name and title and track by default then it prints Aibum in an object
*/
interface album {
    artist: string;
    title : string
...
*/
let magicians : string[ ] = ['Ali','Hamza','Prince']
magicians.forEach(element => {
    show_mag(element)
});
function show_mag(a:string):string{
...
const val:string = prompt('Enter stuff you want in sandwitch.Press 0 to terminate.')!
    goods[i] = val
}
for (let i = 0; i <  10; i++) {
...
function toTitleCase(str: string){
    return str.replace(
     /\w\S*/g,
     (twn) => str.charAt(0).toUpperCase()+str.substring(1).toLowerCase()
    );
}
...
// how can i show each element in a single alert


/*
Question 28
store a info about car in object and make a function that accepts parameters moodel and manufacturer also accept features optional and then print the information
*/
// how can we store info in an object
type car = {
    manufacturer: string,
    model : string,
    arguments: number
...
function infoAboutCar(a:car | car1){
    console.log(a)
}
